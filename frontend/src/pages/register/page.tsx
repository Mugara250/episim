    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-6">
        <div className="w-full max-w-md text-center">
          ...
          <Link to="/login" className="mt-6 inline-block text-sm font-medium text-brand-light hover:underline">
            Back to sign in
          </Link>
        </div>
      </main>
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          ...
          <label className="flex items-start gap-2 text-sm text-text-secondary">
            ...
            <span>
              I agree to the{" "}
              <Link to="#" className="text-brand-light hover:underline">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link to="#" className="text-brand-light hover:underline">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-brand px-4 py-3 text-sm font-bold text-bg transition hover:bg-brand-light disabled:opacity-50"
          >
