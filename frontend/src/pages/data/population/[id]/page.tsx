...
export default function PopulationDatasetDetailPage() {
  ...
  return (
    <>
      ...
      <Link to="/data/population" className="text-sm text-text-secondary hover:text-brand-light">
        ← Population Datasets
      </Link>
                    ...
                    return (
                      <tr key={v.id} className={v.id === dataset.id ? "bg-brand/5" : ""}>
                        ...
                        <td className="px-4 py-3 text-right">
                          {v.id !== dataset.id && (
                            <Link to={`/data/population/${v.id}`} className="text-xs text-brand-light hover:underline">
                              View
                            </Link>
                          )}
                        </td>
